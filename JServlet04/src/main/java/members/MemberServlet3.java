...
public class MemberServlet3 extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		System.out.println("[MemberServlet3] (/membrlist), init...");
	}

	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("[MemberServlet3] (/membrlist), GET...");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("[MemberServlet3] (/membrlist), POST...");
		doProcess(request, response);
	}
	...
	static void outHtmlFooter(PrintWriter out) {
		out.print("</table>");
		out.print("<a href='/JServlet04/memberlist.html'>멤버 등록</a>");
		out.print("</body></html>");
	}
