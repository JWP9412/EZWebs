/*
 * http://localhost:8090/JServlet06G/memberview
 */
package members;
...
public class MemberView extends HttpServlet {
	...
	static void outHtmlMembers(PrintWriter out, List<MemberVO> members) {
		...
		for(int cnt=0; cnt < members.size(); cnt++) {
			...
			out.print("<tr>");
			out.printf("<td><a href='/JServlet06G/memberdetail?mid=%s'>%s</a></td>", member.getMid(), member.getMid());
			...
			out.printf("<td><a href='/JServlet06G/memberlist?command=delMember&mid=%s'>삭제</a></td>", member.getMid());
			out.printf("<td><a href='/JServlet06G/memberedit?mid=%s'>수정</a></td>", member.getMid());
			out.print("</tr>");
		}
	}
	...
	static void outHtmlFooter(PrintWriter out) {
		out.print("</table>");
		out.print("<a href='/JServlet06G/memberlist.html'>멤버등록</a>");
		out.print("</body></html>");
	}
