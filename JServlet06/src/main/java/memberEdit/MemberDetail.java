...
public class MemberDetail extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		System.out.println("[MemberDetail] (/memberdetail), init...");
	}

	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("[MemberDetail] (/memberdetail), GET...");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("[MemberDetail] (/memberdetail), POST...");
		doProcess(request, response);
	}
	...
	static void outHtmlFooter(PrintWriter out) {
		out.print("<a href='/JServlet06/memberlist.html'>멤버 리스트</a>");
		out.print("</body></html>");
	}
