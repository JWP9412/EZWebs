...
public class MemberEdit extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		System.out.println("[MemberEdit] (/memberedit), init...");
	}
	...
	static void outHtmlHeader(PrintWriter out) {
		out.print("<html><body>");
		out.print("<h1>멤버 수정</h1><hr>");
		out.print("<hr>");
	}

	static void outHtmlMembers(PrintWriter out, MemberVO member) {
		if(member == null ) {
			return;
		}
